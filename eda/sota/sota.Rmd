...
100% of the metrics for reasoning, audio, adversarial, and knowledge base were only measured once, which means we won't be able to get anything meaningful from these categories. 
...
Methodology has the outliers. There really shouldn't be negative percent change. Did I calculate something wrong?
